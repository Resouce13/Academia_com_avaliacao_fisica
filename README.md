# Academia_com_avaliacao_fisica
Trabalho da disciplina de Laboratório de Bando de Dados. 
Ministrada pelo professor Samuel Novais Moura Júnior. 
Trabalho pertencente aos integrantes: Gabriel Araújo de Almeida e João Paulo Sebastian.
Tema: Academia com Avaliação Física.
O projeto desenvolve um banco de dados para gerenciar uma academia, incluindo alunos, profissionais, planos e contratos.
